// Test avec des formules simplifiées et éprouvées
// Basé sur des formules standard de calcul des heures de prière
...
console.log('🔍 Test avec formules simplifiées\n');
...
// Calcul simplifié du jour julien
...
// Calcul simplifié des coordonnées solaires
function getSunCoordinates(date) {
    ...
    const equationOfTime = (q - toDegrees(ra)) / 15;
...
// Calcul simplifié de l'heure d'une prière
...
// Calculs avec les formules simplifiées
try {
    ...
    console.log('📊 COMPARAISON AVEC FORMULES SIMPLIFIÉES:');
    console.log('┌─────────────┬──────────┬──────────┬──────────┬─────────┐');
